...
class ResponseHeaders
{
    ...
    const HEADER_X_POWERED_BY_CONTENT = 'Cloud Control Microservice - https://getcloudcontrol.org';
    ...
    {
        self::add(self::HEADER_SET_COOKIE, '__Host-sess=' . session_id() . '; path=' . App::getSubfolders() . '; Secure; HttpOnly; SameSite;');
        if (Request::isSecure()) {
